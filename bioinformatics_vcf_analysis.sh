...
# Please ensure that to start off, you have the 1000 genomes
# phase 3 release VCF file in the same directory as this script.
# Ensure that the VCF file is named "all.vcf"
...
echo PRINTING METADATA LINES. . .
grep "^##" *.vcf

COMMENT

# Use https://www.internationalgenome.org/data-portal/sample
# to figure out which columns correspond to Puerto Ricans
# Look at the additional information in the paper below
# to see the SNPS chosen here
# https://doi.org/10.1186/1471-2156-10-45

# Create a list of Puerto Rican IDs (hardcoded as a bash array)
puerto_rican_ids=(
    HG00554 HG00733 HG00738 HG00555 HG01243 HG01248 HG01286 HG01301 HG00637
...
# Create a list of rs numbers to filter by (hardcoded)
rs_numbers=(
    rs2230806 rs2297404 rs4149272 rs2575875 rs363717 rs4148189 rs3806471 rs6720173
